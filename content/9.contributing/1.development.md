...
Contributors should validate the layer they touch and keep examples aligned with the public documentation.
...
See [Source examples](/examples/text-and-chat) for the detailed example pages.
