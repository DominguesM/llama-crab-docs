---
title: Examples
description: Runnable Rust and Tauri examples that cover every public feature of llama-crab 0.1.7.
navigation:
...
The workspace pins **`llama-crab` 0.1.7** and enables the `hf-hub` and
...
```bash [Terminal]
cargo install llama-crab-server --version 0.1.7 --features mtmd --force
```
