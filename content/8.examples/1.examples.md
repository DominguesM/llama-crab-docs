---
title: Examples
description: Runnable Rust and Tauri examples that cover every public feature of llama-crab 0.1.6.
navigation:
...
The workspace pins **`llama-crab` 0.1.6** and enables the `hf-hub` and
