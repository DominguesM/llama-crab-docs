---
title: Backends
description: Select llama-crab compute backends with Cargo features.
navigation:
  icon: i-lucide-cpu
seo:
  title: Backends
...
| OpenCL accelerator | `opencl`, `openmp` |
| Arm KleidiAI matrix kernels | `kleidiai` |
...
```toml
[dependencies]
llama-crab = { version = "0.1.6", default-features = false, features = ["metal", "openmp"] }
```
