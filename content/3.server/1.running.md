...
description: Install, start, and configure the llama-crab server process.
navigation:
  icon: i-lucide-play
seo:
  title: Running the Server
...
Source checkout commands are covered in [Development](/contributing/development).
