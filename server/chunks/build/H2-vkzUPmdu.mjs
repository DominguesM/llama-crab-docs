...
import { n as useComponentProps, p as useAppConfig, Z as useRuntimeConfig, t as tv, w as _sfc_main$K } from './server.mjs';
...
return (_ctx, _push, _parent, _attrs) => {
  ...
  if (unref(props).id && generate.value) {
    _push(`<a${
      ssrRenderAttr("href", `#${unref(props).id}`)
    } class="${
      ssrRenderClass(ui.value.link({ class: unref(props).ui?.link }))
    }"><span class="${
...
_sfc_main.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/@nuxt/ui/dist/runtime/components/prose/H2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
};

export { _sfc_main as default };
//# sourceMappingURL=H2-vkzUPmdu.mjs.map
