...
import { n as useComponentProps, p as useAppConfig, t as tv, _ as _sfc_main$F, w as _sfc_main$K } from './server.mjs';
...
return (_ctx, _push, _parent, _attrs) => {
  ...
  if (unref(props).to) {
    _push(ssrRenderComponent(_sfc_main$F, mergeProps({ "aria-label": ariaLabel.value }, { to: unref(props).to, target: target.value, ..._ctx.$attrs }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/@nuxt/ui/dist/runtime/components/prose/Card.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
};

export { _sfc_main as default };
//# sourceMappingURL=Card-O6HnG_7_.mjs.map
