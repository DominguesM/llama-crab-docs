...
return (_ctx, _push, _parent, _attrs) => {
  _push(`<div${
    ...
    ssrRenderClass(ui.value.preview({ class: [unref(props).ui?.preview] }))
  }">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/@nuxt/ui/dist/runtime/components/prose/CodePreview.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
};

export { _sfc_main as default };
//# sourceMappingURL=CodePreview-C3x6eBvc.mjs.map
