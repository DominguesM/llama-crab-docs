...
import { a0 as defu } from '../nitro/nitro.mjs';
import { p as useAppConfig, w as _sfc_main$K } from './server.mjs';
import 'lru-cache';
import '@unocss/core';
...
return (_ctx, _push, _parent, _attrs) => {
  if (icon.value) {
    _push(ssrRenderComponent(_sfc_main$K, mergeProps({ name: icon.value }, _attrs), null, _parent));
  } else {
    _push(`<!---->`);
  }
}
...
_sfc_main.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/@nuxt/ui/dist/runtime/components/prose/CodeIcon.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
};

export { _sfc_main as default };
//# sourceMappingURL=CodeIcon-DqYJP6Hz.mjs.map
