...
import { n as useComponentProps, o as useLocale, p as useAppConfig, t as tv, G as transformUI, w as _sfc_main$K, q as useForwardProps, a3 as CollapsibleRoot_default, a4 as CollapsibleTrigger_default, a5 as CollapsibleContent_default } from './server.mjs';
...
return (_ctx, _push, _parent, _attrs) => {
  _push(ssrRenderComponent(unref(CollapsibleRoot_default), mergeProps(unref(rootProps), {
    ...
    default: withCtx(({ open }, _push, _parent, _scopeId) => {
      if (_push) {
        if (!!slots.default) {
          _push(ssrRenderComponent(unref(CollapsibleTrigger_default), { "as-child": "" }, {
        ...
        return [
          (!!slots.default)
            ? (openBlock(), createBlock(unref(CollapsibleTrigger_default), {
                key: 0,
                "as-child": ""
              }, {
                default: withCtx(() => [
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/@nuxt/ui/dist/runtime/components/Collapsible.vue");
...
return (_ctx, _push, _parent, _attrs) => {
  _push(ssrRenderComponent(_sfc_main$1, mergeProps({
    ...
    default: withCtx(({ open }, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`<button class="${
          ssrRenderClass(ui.value.trigger({ class: unref(props).ui?.trigger }))
        }"${
          _scopeId
        }>`);
        ...
        _push(`<span class="${
          ...
          ssrInterpolate(open ? unref(props).closeText || unref(t)("prose.collapsible.closeText") : unref(props).openText || unref(t)("prose.collapsible.openText"))
        } ${
          ssrInterpolate(unref(props).name || unref(t)("prose.collapsible.name"))
        }</span></button>`);
      } else {
        return [
          createVNode("button", {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/@nuxt/ui/dist/runtime/components/prose/Collapsible.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
};

export { _sfc_main as default };
//# sourceMappingURL=Collapsible-BS0yHRbv.mjs.map
