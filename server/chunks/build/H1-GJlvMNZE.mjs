...
import { n as useComponentProps, p as useAppConfig, Z as useRuntimeConfig, t as tv } from './server.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/@nuxt/ui/dist/runtime/components/prose/H1.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
};

export { _sfc_main as default };
//# sourceMappingURL=H1-GJlvMNZE.mjs.map
