import { aJ as __nuxt_component_0$1 } from './server.mjs';
...
return (_ctx, _push, _parent, _attrs) => {
  ...
  }</h1><p class="text-2xl max-w-3xl" style="${
  ...
  if (__props.logo) {
    ...
    } class="absolute bottom-0 left-0 p-5" style="${
      ssrRenderStyle({"height":"125px","width":"153px"})
    }">`);
  } else {
    _push(`<!---->`);
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
};

export { _sfc_main as default };
//# sourceMappingURL=Frame-CJTl8I-H.mjs.map
