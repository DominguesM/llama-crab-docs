...
return (_ctx, _push, _parent, _attrs) => {
  _push(`<div${
    ssrRenderAttrs(mergeProps({ class: "w-full h-full flex flex-col bg-white" }, _attrs))
  }><div class="pt-[60px] pb-[70px] px-[6.75rem] h-full flex flex-col justify-between"><div class="flex flex-row justify-between"><div class="max-w-[700px]"><h1 class="mb-[30px] max-w-[700px] text-[60px] text-gray-900 font-normal flex flex-row"><p style="${
    ssrRenderStyle({"display":"block","overflow":"hidden","line-clamp":"1","text-overflow":"clip"})
  }">${
    ssrInterpolate(org.value)
  }</p>`);
  if (repo.value) {
    _push(`<p style="${ssrRenderStyle({"display":"block","overflow":"hidden","line-clamp":"1","text-overflow":"clip"})}" class="ml-2"> / </p>`);
  } else {
    _push(`<!---->`);
  }
  if (repo.value) {
    _push(`<p style="${
      ...
      ssrInterpolate(repo.value)
    }</p>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</h1><p class="text-gray-500 max-w-[700px] text-[35px] leading-[60px]" style="${
    ssrRenderStyle({"display":"block","line-clamp":"3","text-overflow":"ellipsis"})
  }">${
    ssrInterpolate(description.value)
  }</p></div><div class="text-[200px]">${
    ssrInterpolate(__props.emoji)
  }</div></div><div class="flex flex-row items-center justify-between"><div class="flex flex-row text-[40px]"><div class="flex flex-row pr-10"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32"><path fill="#888888" d="m4.67 28l6.39-12l7.3 6.49a2 2 0 0 0 1.7.47a2 2 0 0 0 1.42-1.07L27 10.9l-1.82-.9l-5.49 11l-7.3-6.49a2 2 0 0 0-1.68-.51a2 2 0 0 0-1.42 1L4 25V2H2v26a2 2 0 0 0 2 2h26v-2Z"></path></svg><div class="pl-2"><div>${
    ssrInterpolate(downloads.value)
  }</div><div class="text-lg text-gray-600"> Monthly Downloads </div></div></div><div class="flex flex-row pr-10"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32"><path fill="#888888" d="m16 6.52l2.76 5.58l.46 1l1 .15l6.16.89l-4.38 4.3l-.75.73l.18 1l1.05 6.13l-5.51-2.89L16 23l-.93.49l-5.51 2.85l1-6.13l.18-1l-.74-.77l-4.42-4.35l6.16-.89l1-.15l.46-1L16 6.52M16 2l-4.55 9.22l-10.17 1.47l7.36 7.18L6.9 30l9.1-4.78L25.1 30l-1.74-10.13l7.36-7.17l-10.17-1.48Z"></path></svg><div class="pl-2"><div>${
    ssrInterpolate(stars.value)
  }</div><div class="text-lg text-gray-600"> Stars </div></div></div><div class="flex flex-row pr-10"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32"><path fill="#888888" d="M22.45 6a5.47 5.47 0 0 1 3.91 1.64a5.7 5.7 0 0 1 0 8L16 26.13L5.64 15.64a5.7 5.7 0 0 1 0-8a5.48 5.48 0 0 1 7.82 0l2.54 2.6l2.53-2.58A5.44 5.44 0 0 1 22.45 6m0-2a7.47 7.47 0 0 0-5.34 2.24L16 7.36l-1.11-1.12a7.49 7.49 0 0 0-10.68 0a7.72 7.72 0 0 0 0 10.82L16 29l11.79-11.94a7.72 7.72 0 0 0 0-10.82A7.49 7.49 0 0 0 22.45 4Z"></path></svg><div class="pl-2"><div>${
    ssrInterpolate(__props.contributors)
  }</div><div class="text-lg text-gray-600"> Contributors </div></div></div></div><div class="flex flex-row"><svg width="100" height="100" class="rounded-[0.25rem] w-[100px] h-[100px]" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_206_4645)"><mask id="mask0_206_4645" style="${
...
_sfc_main.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
};

export { _sfc_main as default };
//# sourceMappingURL=UnJs-DVWTKX_z.mjs.map
