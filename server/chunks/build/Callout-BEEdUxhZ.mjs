...
return (_ctx, _push, _parent, _attrs) => {
  ...
  if (unref(props).to) {
    _push(ssrRenderComponent(_sfc_main$F, mergeProps({ to: unref(props).to, target: target.value, ..._ctx.$attrs }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("node_modules/@nuxt/ui/dist/runtime/components/prose/Callout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
};

export { _sfc_main as default };
//# sourceMappingURL=Callout-BEEdUxhZ.mjs.map
