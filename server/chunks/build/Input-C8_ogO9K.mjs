...
import { n as useComponentProps, p as useAppConfig, H as useFormField, I as useFieldGroup, J as useComponentIcons, t as tv, P as Primitive, w as _sfc_main$K, x as _sfc_main$H, K as looseToNumber } from './server.mjs';
...
const { emitFormBlur, emitFormInput, emitFormChange, size: formFieldSize, color, id, name, highlight, disabled, emitFormFocus, ariaAttrs } = useFormField(_props, { });
      ...
      if (_push) {
        ...
        if (unref(isTrailing) || !!slots.trailing) {
          _push(`<span data-slot="trailing" class="${
            ssrRenderClass(ui.value.trailing({ class: unref(props).ui?.trailing }))
          }"${
            _scopeId
          }>`);
        ...
        return [
          ...
          (unref(isLeading) || !!unref(props).avatar || !!slots.leading)
...
//# sourceMappingURL=Input-C8_ogO9K.mjs.map
