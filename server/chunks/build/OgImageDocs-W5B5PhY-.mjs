  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(description)) {
        _push(`<p class="text-[32px] text-neutral-300 leading-tight w-[700px]">${ssrInterpolate(unref(description))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/docus/app/components/OgImage/OgImageDocs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const OgImageDocs = Object.assign(_sfc_main, { __name: "OgImageDocs" });

export { OgImageDocs as default };
//# sourceMappingURL=OgImageDocs-W5B5PhY-.mjs.map
